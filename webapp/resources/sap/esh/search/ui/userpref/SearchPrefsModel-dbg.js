...
sap.ui.define(["../i18n", "sap/ui/model/json/JSONModel"], function (__i18n, JSONModel) {
  ...
  var SearchPrefsModel = /*#__PURE__*/function (_JSONModel) {
    ...
    _createClass(SearchPrefsModel, [{
      key: "asyncInit",
      value: //const path = "sap.esh.search.ui.userpref.SearchPrefsModel";
      function asyncInit() {
        var _this = this;
        ...
        this.initializePromise = this.searchModel.initBusinessObjSearch().then(function () {
      ...
      value: function initSubDataSources() {
        ...
        this.searchModel.getUserCategoryManager().then(function (userCategoryManager) {
          ...
          _this2.userCategory = userCategoryManager.getCategory("MyFavorites"); // get datasources from sina
