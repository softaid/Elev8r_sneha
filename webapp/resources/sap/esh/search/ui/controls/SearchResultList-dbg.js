...
(function(){
sap.ui.define(["sap/esh/search/ui/SearchHelper", "sap/m/List"], function (SearchHelper, List) {
  ...
  var SearchResultList = List.extend("sap.esh.search.ui.controls.SearchResultList", {
    ...
    _doCollectListItemsForNavigation: function _doCollectListItemsForNavigation() {
      ...
      oItemNavigation.setItemDomRefs(aDomRefs); // turn of the cycling
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              ...
              if ((listItemContent === null || listItemContent === void 0 ? void 0 : listItemContent.length) > 0) {
                ...
                (_listItemContent$ = listItemContent[0]) === null || _listItemContent$ === void 0 ? void 0 : _listItemContent$.resizeEventHappened();
              }
            }
          } catch (err) {
            _iterator.e(err);
