  ...
  var SearchCompositeControl = Control.extend("sap.esh.search.ui.SearchCompositeControl", {
    ...
    constructor: function _constructor(sId, settings) {
      ...
      try {
        ...
        settings = unifiedParameters.settings; // create search model (within search model the SearchConfiguration is created and initialized with settings)
        ...
        initialErrorHandler.setSearchModel(searchModel); // call super constructor with all UI5 relevant settings

        var settingsKnownToUI5 = SearchCompositeControl.getUI5ControlSettings(searchModel.config);
        Control.prototype.constructor.call(this, sId, settingsKnownToUI5); // init composite control
        ...
        searchModel.focusHandler = this.oFocusHandler; // create views
        ...
        createContentRunning = false; // trigger async search init
    ...
    initSearch: function _initSearch() {
      ...
      searchModel.searchUrlParser.parse().then(function () {
        searchModel.initAsync().then(function () {
          if (_this.getProperty("searchOnStart") && !searchModel.config.isUshell) {
    ...
    exit: function _exit() {
      if (this.oErrorPopover) {// ugly workaround for BCP 2280141554
    ...
    createContent: function _createContent() {
      ...
      this.oSearchBar = new Bar(this.getId() + "-searchBar", {
        ...
        contentRight: this.assembleGenericButtonsToolbar()
      });
    ...
    assembleFilterButton: function _assembleFilterButton() {
      ...
      var filterBtn = new ToggleButton(this.getId() + "-searchBarFilterButton", {
        ...
        press: function press(oEvent) {
          ...
          _this3.searchContainer.setProperty("animateFacetTransition", true);

          oModel.setFacetVisibility(oEvent.getParameter("pressed"));

          _this3.searchContainer.setProperty("animateFacetTransition", false);
        },
        visible: {
          parts: [{
    ...
    assembleSearchCountBreadcrumbs: function _assembleSearchCountBreadcrumbs() {
      ...
      if (oModel !== null && oModel !== void 0 && (_oModel$config3 = oModel.config) !== null && _oModel$config3 !== void 0 && _oModel$config3.assembleSearchCountBreadcrumbs) {
        var searchCountBreadcrumbsCustom = oModel.config.assembleSearchCountBreadcrumbs(oModel.getDataSource(), count);

        if (searchCountBreadcrumbsCustom instanceof Control) {
          searchCountBreadcrumbs = searchCountBreadcrumbsCustom;
        }
      } else {
        searchCountBreadcrumbs = new SearchCountBreadcrumbs(this.getId() + "-SearchCountBreadcrumbs");
      }

      searchCountBreadcrumbs.addStyleClass("sapElisaSearchContextBarContent");
      searchCountBreadcrumbs.addStyleClass("sapUiSmallMarginBegin");
    ...
    assembleGenericButtonsToolbar: function _assembleGenericButtonsToolbar() {
      ...
      var oModel = this.getModel();
      var toolbar = [];
      var bWithShareButton = oModel === null || oModel === void 0 ? void 0 : (_oModel$config4 = oModel.config) === null || _oModel$config4 === void 0 ? void 0 : _oModel$config4.isUshell;
      ...
      var customToolbar = oModel === null || oModel === void 0 ? void 0 : (_oModel$config5 = oModel.config) === null || _oModel$config5 === void 0 ? void 0 : _oModel$config5.getCustomToolbar();
      ...
      container.addEventDelegate({
        onAfterRendering: function onAfterRendering() {
          ...
          /*        this.getItems().forEach((element) => {
              element.getContent().addStyleClass("sapUshellSearchTileWrapper");
          }); */
    ...
    onAllSearchFinished: function _onAllSearchFinished() {
      ...
      if (oModel.getProperty("/count") > 0) {
        ...
        if (oModel !== null && oModel !== void 0 && (_oModel$config6 = oModel.config) !== null && _oModel$config6 !== void 0 && _oModel$config6.assembleSearchCountBreadcrumbs) {
          var _oModel$config7, _oModel$config8, _oModel$config9;

          this.oSearchCountBreadcrumbs = this.assembleSearchCountBreadcrumbs();

          if (oModel !== null && oModel !== void 0 && (_oModel$config7 = oModel.config) !== null && _oModel$config7 !== void 0 && _oModel$config7.combinedResultviewToolbar && !(oModel !== null && oModel !== void 0 && (_oModel$config8 = oModel.config) !== null && _oModel$config8 !== void 0 && _oModel$config8.FF_unifiedToolbarsWithContextBar)) {
            this.oCombinedResultviewToolbar = new VBox("", {
              items: [this.oFilterBar, this.oSearchCountBreadcrumbs, this.oSearchBar]
            }).addStyleClass("sapElisaCombinedResultViewToolbar");
            this.oCombinedResultviewToolbar.addStyleClass("sapUiNoMarginBegin");
            this.oCombinedResultviewToolbar.addStyleClass("sapUiNoMarginEnd");
            this.oSearchResultContainer.setCombinedResultviewToolbar(this.oCombinedResultviewToolbar);
          } else if (oModel !== null && oModel !== void 0 && (_oModel$config9 = oModel.config) !== null && _oModel$config9 !== void 0 && _oModel$config9.FF_unifiedToolbarsWithContextBar) {
            this.oContextBar.destroyContentLeft();
            this.oContextBar.addContentLeft(this.oSearchCountBreadcrumbs);
            this.oCombinedResultviewToolbar = new VBox("", {
            ...
            this.oSearchResultContainer.setCountBreadcrumbs(oModel.config.assembleSearchCountBreadcrumbs(oModel.getDataSource(), oModel.getProperty("/count")));
          }
        }
      }
      ...
      this.oFocusHandler.setFocus(); // the search-app container of FLP has ID "viewPortContainer"
    ...
    createSearchPage: function _createSearchPage(idPrefix) {
      ...
      this.oFilterBar.bindProperty("visible", {
        ...
        formatter: function formatter(facetVisibility, rootCondition) {
          ...
          _this17.adjustSearchLayoutStyleClasses(filterBarVisible, oModel.config.combinedResultviewToolbar, oModel.config.FF_unifiedToolbarsWithContextBar);
      ...
      if (oModel !== null && oModel !== void 0 && (_oModel$config10 = oModel.config) !== null && _oModel$config10 !== void 0 && _oModel$config10.FF_unifiedToolbarsWithContextBar) {
        searchPageContent = [// generic buttons
        this.oSearchBar, // filter bar
        this.oFilterBar, // search container (responsive splitter)
        this.searchContainer];
      } else if (oModel.config.combinedResultviewToolbar) {
        searchPageContent = [// search container (responsive splitter)
        this.searchContainer];
      } else {
        searchPageContent = [// generic buttons
        this.oSearchBar, // filter bar
    ...
    createNoResultScreen: function _createNoResultScreen(idPrefix, useIllustratedMessage) {
      var _this18 = this;

      if (useIllustratedMessage) {
        // modern UX, sap.m.useIllustratedMessage
        ...
        var oIllustratedMessage = new IllustratedMessage("".concat(idPrefix, "-searchContainerResultsView-noResultScreen-illustratedMessage"), illustratedMessageSettings).addStyleClass("repositoryExplorerCustomNoResultScreen");
        ...
        // legacy UX, lots of homebrew css, based on @media @searchPhoneSize ( = ~"(max-width: 767px)" )
        this.noResultScreen = new SearchNoResultScreen("".concat(idPrefix, "-searchContainerResultsView-noResultScreen"), {
          ...
          visible: {
            ...
            formatter: function formatter(count, isBusy, firstSearchWasExecuted) {
              ...
              _this18._oLogger.debug("No result screen is visible: \" ".concat(visible, ". count: ").concat(count, ", isBusy: ").concat(isBusy, ", firstSearchWasExecuted: ").concat(firstSearchWasExecuted));
          ...
          toolbar: [
            /* new Button({ obsolete
                ...
                visible: { path: "/config/displayNoResultsPageBackButton" },
                press: () => {
                    window.history.back();
                },
            ...
            /* new Button({
                ...
                visible: { path: "/config/displayNoResultsPageSearchAllButton" },
                press: () => {
                    const oModel = this.getModel() as SearchModel;
                    oModel.resetTop();
        ...
        if (oModel.config.FF_optimizeForValueHelp) {
          this.noResultScreen.addStyleClass("sapUshellSearch-no-result-valueHelp");
        }
      }
    ...
    createSearchContainer: function _createSearchContainer(idPrefix) {
      var _oModel$config11, _oModel$config12, _oModel$config13;

      var oModel = this.getModel(); // total count hidden element for ARIA purposes
      ...
      if (oModel !== null && oModel !== void 0 && (_oModel$config11 = oModel.config) !== null && _oModel$config11 !== void 0 && _oModel$config11.combinedResultviewToolbar && !(oModel !== null && oModel !== void 0 && (_oModel$config12 = oModel.config) !== null && _oModel$config12 !== void 0 && _oModel$config12.FF_unifiedToolbarsWithContextBar)) {
        ...
        this.oCombinedResultviewToolbar = new VBox("", {
          items: [this.oFilterBar, this.oSearchBar, this.oContextBar]
        }).addStyleClass("sapElisaCombinedResultViewToolbar");
        this.oCombinedResultviewToolbar.addStyleClass("sapUiNoMarginBegin");
        this.oCombinedResultviewToolbar.addStyleClass("sapUiNoMarginEnd");
        this.oSearchResultContainer = new SearchResultContainer("".concat(idPrefix, "-searchContainerResultsView"), {
          ...
          combinedResultviewToolbar: this.oCombinedResultviewToolbar,
          combinedResultviewToolbarHiddenElement: this.countBreadcrumbsHiddenElement,
          noResultScreen: this.createNoResultScreen(idPrefix, true)
        });
      } else if (oModel !== null && oModel !== void 0 && (_oModel$config13 = oModel.config) !== null && _oModel$config13 !== void 0 && _oModel$config13.FF_unifiedToolbarsWithContextBar) {
        this.oContextBar = new Bar(this.getId() + "-searchContextBar", {
          contentLeft: this.oSearchCountBreadcrumbs
        }).addStyleClass("sapElisaSearchContextBar");
        this.oCombinedResultviewToolbar = new VBox("", {
        ...
        this.oSearchResultContainer = new SearchResultContainer("".concat(idPrefix, "-searchContainerResultsView"), {
          centerArea: this.centerArea,
          countBreadcrumbs: this.oSearchCountBreadcrumbs,
      ...
      var searchLayoutResponsiveSettings = {
        ...
        unifiedToolbarsWithContextBar: oModel.config.FF_unifiedToolbarsWithContextBar
      };
    ...
    adjustSearchLayoutStyleClasses: function _adjustSearchLayoutStyleClasses(filterBarVisible, combinedResultviewToolbar, unifiedToolbarsWithContextBar) {
      ...
      if (filterBarVisible) {
        if (combinedResultviewToolbar && !unifiedToolbarsWithContextBar) {
          this.searchContainer.addStyleClass("sapUshellSearchLayoutHeightCombinedToolbarFilterbar");
        } else {
          this.searchContainer.addStyleClass("sapUshellSearchLayoutHeightFilterbar");
        }
      } else {
        if (combinedResultviewToolbar && !unifiedToolbarsWithContextBar) {
          this.searchContainer.addStyleClass("sapUshellSearchLayoutHeightCombinedToolbarDefault");
        } else {
    ...
    createFooter: function _createFooter(idPrefix) {
      ...
      var oErrorButton = new Button(this.getId() + "-searchErrorButton", {
        ...
        press: function press() {
          if (_this19.oErrorPopover.isOpen()) {
            _this19.oErrorPopover.close();
          } else {
            _this19.oErrorPopover.setVisible(true);

            _this19.oErrorPopover.openBy(oErrorButton);
          }
        }
      });
    ...
    chooseNoResultScreen: function _chooseNoResultScreen() {
      var _oModel$config14;

      // update "no result screen"
      var oModel = this.getModel();
      var noResultScreen;

      if (typeof (oModel === null || oModel === void 0 ? void 0 : (_oModel$config14 = oModel.config) === null || _oModel$config14 === void 0 ? void 0 : _oModel$config14.getCustomNoResultScreen) === "function") {
