sap.ui.define([
...
], function (jQuery, library, Control, Parameters, TAccountPanel, IconPool, Icon, Button, encodeXML, Configuration, ItemNavigation, TAccountUtils, ResizeHandler, BigNumber) {
	"use strict";
	...
	TAccountGroup.prototype._getAriaText = function () {
		return oResourceBundle.getText("TACCOUNT_GROUP_TITLE") + " " + (this.getTitle() ? (encodeXML(this.getTitle()) + " ") : "") + this._getSumText();
	};
