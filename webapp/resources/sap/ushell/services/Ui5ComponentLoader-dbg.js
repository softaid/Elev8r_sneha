...
sap.ui.define([
     ...
     * @param {*} oConfig Used to configure the loader with properties amendedLoading and coreResourcesComplement
     * @constructor
     * @private
     * @constructor
    ...
    function Ui5ComponentLoader (oAdapter, oContainerInterface, sParameter, oConfig) {
        ...
        */
        ...
        this.getCoreResourcesComplementBundle = function () {
            return oUtils.prepareBundle(this._oConfig.coreResourcesComplement);
        };
