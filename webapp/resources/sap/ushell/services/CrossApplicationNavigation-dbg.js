...
sap.ui.define([
    ...
    function CrossApplicationNavigation (oContainerInterface, sParameters, oServiceConf) {
        ...
        this.toExternal = function (oArgs, oComponent) {
            ...
            return Promise.all([
                ...
                .catch(function (oError) {
                    Log.warning("Shell not available, no Cross App Navigation");
                });
        };
        ...
        this.hrefForAppSpecificHash = function (sAppHash) {
            ...
            if (sap.ushell && sap.ushell.Container && typeof sap.ushell.Container.getService === "function") {
        ...
        this._getLinks = function (oNominalArgs) {
            ...
            var oNominalArgsClone = jQuery.extend(true, {}, oNominalArgs);
         ...
         *
         * This is effectively a test function for {@link sap.ushell.services.CrossApplicationNavigation#toExternal}/ {@link sap.ushell.services.CrossApplicationNavigation#hrefForExternal}.
         * It is functionally equivalent to {@link sap.ushell.services.CrossApplicationNavigation#isIntentSupported}
         * but accepts the same interface as {@link sap.ushell.services.CrossApplicationNavigation#toExternal}/ {@link sap.ushell.services.CrossApplicationNavigation#hrefForExternal}.
         *
         ...
         *   <code>{ target: { shellHash: "SO-36&jumper=postman" } }</code>
         * @param {object} [oComponent] the root component of the application
         * @returns {jQuery.Promise} A <code>jQuery.Deferred</code> object's promise which is resolved with an array (!) of objects representing
         ...
         * @returns {jQuery.Promise} A <code>jQuery.Deferred</code> object's promise which is resolved if the URL is supported and rejected if not.
        ...
        this.createComponentData = function (sIntent, oConfig) {
            return new Promise(function (fnResolve, fnReject) {
                ...
                sCanonicalIntent = UrlParsing.constructShellHash(UrlParsing.parseShellHash(sIntent));
                if (!sCanonicalIntent) {
                ...
                oContainer.getServiceAsync("NavTargetResolution").then(function (NavTargetResolution) {
                    NavTargetResolution.resolveHashFragment("#" + sCanonicalIntent).then(function (oResult) {
                        function finalizeResult (oResultNew) {
                            oResultNew = jQuery.extend(true, {}, oResultNew, oConfig);
