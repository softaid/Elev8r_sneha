...
sap.ui.define([
    ...
    var Pages = function () {
        ...
        this._oURLParsingServicePromise = sap.ushell.Container.getServiceAsync("URLParsing");
     ...
     * @private
     */
    Pages.prototype._getVisualizationData = function (sPageId, sVizId, oVisualizations, oAdditionalVizData, oApplications, oVizTypes, oURLParsingService, oSystemContext) {
        ...
        var oVizData = readUtils.getVizData(oSite, oVisualizationReference, oURLParsingService, oSystemContext);
        if (!oVizData.id) {
        ...
        return this._oCdmServicePromise
            ...
            .then(function (oCdmService) {
                return Promise.all([
                    ...
                    this._oURLParsingServicePromise
                ])
                    .catch(function (oError) {
                    ...
                    return Promise.all(oCDMPageSection.layout.vizOrder.map(function (id) {
                        ...
                        return oCSTRService.getSystemContext(oVisualizationReference.contentProviderId)
                            .then(function (oSystemContext) {
                                var oVizData = this._getVisualizationData(page.identification.id, sVizId, visualizations,
                                    oVisualizationReference, applications, vizTypes, oURLParsingService, oSystemContext);
    ...
    Pages.prototype.addBookmarkToPage = function (pageId, bookmark, sectionId, sContentProviderId) {
        ...
        return Promise.all([
            ...
            .then(function (aResults) {
                ...
                var oVizData = this._getVisualizationData(pageId, undefined, {}, oVizRef, {}, oVizTypes, oURLParsingService, oSystemContext);
    ...
    Pages.prototype._findBookmarks = function (oIdentifier) {
        ...
        var aVizReferences = [];
        return this._oURLParsingServicePromise
            .then(function (oURLParsingService) {
                var oTarget = utilsCdm.toTargetFromHash(oIdentifier.url, oURLParsingService);
    ...
    Pages.prototype.updateBookmarks = function (oIdentifier, oParameters) {
        ...
        return Promise.all([
            ...
            .then(function (aResult) {
                var oURLParsingService = aResult[0];
                var aVizReferencesToUpdate = aResult[1];
                ...
                return aVizReferencesToUpdate.reduce(function (oUpdateChain, oIds) {
                    return oUpdateChain
                        ...
                        .then(function (aLocation) {
                            ...
                            if (oParameters.url) {
                                oVisualizationData.target = readUtils.harmonizeTarget(utilsCdm.toTargetFromHash(oParameters.url, oURLParsingService));
                            }
    ...
    Pages.prototype.updateVisualization = function (iPageIndex, iSourceSectionIndex, iSourceVisualizationIndex, oVisualizationData) {
        return this._oCdmServicePromise
            ...
            .then(function (aResult) {
                ...
                var oURLParsingService = aResult[3];
                ...
                oUpdatedVisualization = this._getVisualizationData(oPageModel.id, oVizRef.vizId,
                    oVisualizations, oVizRef, oApplications, oVizTypes, oURLParsingService);
