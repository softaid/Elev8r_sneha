...
sap.ui.define([
    ...
    "sap/base/Log"
], function (jQuery, Config, ushellLibrary, deepClone, deepExtend, Log) {
    "use strict";
    ...
    function Bookmark () {
        ...
        this.addBookmark = function (oParameters, vContainer, sContentProviderId) {
            ...
            if (typeof vContainer === "undefined" && bEnableSpace) {
                sap.ushell.Container.getServiceAsync("Menu")
                    ...
                    .then(function (oContentNode) {
                        this._addBookmarkToContentNodes(oParameters, [oContentNode], false, sContentProviderId)
            ...
            if ((typeof vContainer === "undefined" || !vContainer.hasOwnProperty("type")) && !Array.isArray(vContainer)) {
                this.addBookmarkToHomepageGroup(oParameters, vContainer, false, sContentProviderId)
                    .then(oDeferred.resolve)
                    .catch(oDeferred.reject);
                return oDeferred.promise();
            }
            ...
            this._addBookmarkToContentNodes(oParameters, aContentNodes, false, sContentProviderId)
                .then(oDeferred.resolve)
                .catch(oDeferred.reject);
