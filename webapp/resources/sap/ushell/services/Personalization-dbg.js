...
sap.ui.define([
     ...
     *
     * Fetching multiple Personalizers for the same container, but different items is not supported.
    ...
    Personalization.prototype._createContainer = function (sContainerKey, oScope, bCreateEmpty, oComponent) {
        ...
        // -- adjust scope
        oAdjustedScope = personalizationUtils.adjustScope(oScope);
        ...
        oChosenAdapter = personalizationUtils.pickAdapter(oScope, oTransientAdapter, oPersistentAdapter);
