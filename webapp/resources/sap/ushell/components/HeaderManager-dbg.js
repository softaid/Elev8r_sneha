...
sap.ui.define([
    ...
    function _subscribeToEvents () {
        ...
        aDoableObjects.push(Config.on("/core/shell/model/currentSpaceAndPage").do(handleCurrentSpaceAndPage));
    }
    ...
    function validateShowLogo (deviceType) {
        var sCurrentState = Config.last("/core/shell/model/currentState/stateName"),
            ...
            bShellLogoVisible = !bIsHeaderLessState;
    ...
    function handleCurrentSpaceAndPage (oCurrentSpaceAndPage) {
        if (Config.last("/core/spaces/enabled") && Config.last("/core/spaces/homeNavigationTarget") === "origin_page") {
            var sNewHash = oCurrentSpaceAndPage ? oCurrentSpaceAndPage.hash : oHeaderDefaultProperties.rootIntent;
    ...
    function updateStates (oParameters) {
        ...
        oPropertyStrategy = _PropertyStrategiesFactory(sPropertyName, oParameters.action);
