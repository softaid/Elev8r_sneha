...
], function (BlueBoxesCache, Application, ApplicationContainer, URI, jQuery, Log, UriParameters, encodeXML) {
    "use strict";
        ...
        var that = this,
            ...
            oHandlers = {
                ...
                create: function (oInnerControl, sUrl, sStorageKey, oTarget) {
                    ...
                    if (sUrl.indexOf("sap-iframe-hint=GUI") > 0 || sUrl.indexOf("sap-iframe-hint=WDA") > 0) {
                        var aInfoArray = [];
