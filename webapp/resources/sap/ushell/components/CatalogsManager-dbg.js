...
sap.ui.define([
    ...
    var CatalogsManager = BaseObject.extend("sap.ushell.components.CatalogsManager", {
         ...
         * @returns {Promise<void>} Resolves once the processing is done
         */
        ...
        /**
         * A wrapper for LaunchPage.getCatalogTileId which ensures that the stableCatalogTileId
         * is only fetched for the required scenarios.
        ...
        _getCatalogTileId: function (oCatalogTile) {
            ...
            /*Always fallback on the catalogTileId. Either getStableCatalogTileId is
            not implemented by the LaunchPageAdapter or spaces is disabled.*/
            if (!sCatalogTileId) {
