...
sap.ui.define([
    ...
    return Controller.extend("sap.ushell.components.appfinder.Catalog", {
        ...
        onInit: function () {
            ...
            Core.byId("catalogSelect").addEventDelegate({
        ...
        onBeforeSelectRendering: function () {
            var oSelect = Core.byId("catalogSelect");
            var aItems = jQuery.grep(oSelect.getItems(), function (oItem) {
        ...
        onTileAfterRendering: function (oEvent) {
            ...
            var jqTileInnerTile = jqTile.find(".sapMGT");
            ...
            oDefaultGroupPromise.done(function (oDefaultGroup) {
                ...
                if (sGroupModelPath) {
                    ...
                    var aRefinedGroups = aGroups.map(function (group) {
                        ...
                        sGroupId = oLaunchPageService.getGroupId(group.object);
                        ...
                        bSelected = !((aTileGroups && Array.prototype.indexOf.call(aTileGroups, sGroupId) === -1));
        ...
        prepareErrorMessage: function (aErroneousActions, sTileTitle) {
            ...
            for (var sKey in aErroneousActions) {
                ...
                oGroup = aErroneousActions[sKey].group;
                sAction = aErroneousActions[sKey].action;
