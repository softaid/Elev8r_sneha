        ...
        /** @lends sap.ushell.components.workPageBuilder.controller.WorkPageBuilder.prototype */ {
            ...
            onAddColumn: function (oEvent) {
                ...
                if (iTotalColumns > MAX_GRID_COLUMN_WIDTH) {
                    this._calculateColWidths(aColumnsData, iColumnIndex, iTotalColumns);
                }
            ...
            setPageData: function (oPageData) {
                this.oModel.setProperty(this._sModelRootPath, oPageData);
            },
             ...
             * @param {object[]} aCatalogData an Array of Visualizations' objects
             *
             * @private
             * @since 1.109.0
             */
            ...
            setCatalogData: function (aCatalogData) {
                this.oModel.setProperty(this._sCatalogRootPath, aCatalogData);
            },
