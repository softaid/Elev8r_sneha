...
sap.ui.define([
    ...
    function _errorMessage (sText) {
        sap.ushell.Container.getServiceAsync("Message").then(function (oMesssageService) {
            oMesssageService.error(sText);
        });
    }
    ...
    Controller.extend("sap.ushell.components.shell.Notifications.Notifications", {
        ...
        getNextBuffer: function () {
            ...
            oPromise.done(function (oResult) {
                var dNotificationsUserSettingsAvailability = this.oNotificationsService._getNotificationSettingsAvalability();
