...
sap.ui.define([
    ...
    var Renderer = UIComponent.extend("sap.ushell.renderers.fiori2.Renderer", {
        ...
        init: function () {
            ...
            oRouter.getRoute("appfinder").attachMatched(function (oEvent) {
                ...
                var oComponent = sap.ui.getCore().getComponent(this.createId("Shell-appfinder-component"));
    ...
    Renderer.prototype._getHomeAppTarget = function () {
        return sap.ushell.Container.getServiceAsync("Ui5ComponentLoader").then(function (Ui5ComponentLoader) {
            ...
            var oComplementBundle = Ui5ComponentLoader.getCoreResourcesComplementBundle();
                ...
                return {
                    ...
                    options: {
                        ...
                        asyncHints: Object.assign({}, oHomeAppComponent.asyncHints || {}, {
                            ...
                            preloadBundles: oComplementBundle.aResources
                        })
                    }
                };
            }
    ...
    Renderer.prototype.setFooterControl = function (controlType, oControlProperties) {
        var sControlResource = controlType.replace(/\./g, "/"),
            ...
            ControlObject = sap.ui.require(sControlResource),
            oControlInstance,
        ...
        if (ControlObject) {
            ...
            Log.error("Renderer.setFooterControl: the referenced control resourse " + controlType + " is not available.",
                undefined, "sap.ushell.renderers.fiori2.Renderer");
            return undefined;
        }

        oControlInstance = this.createItem(oControlProperties, undefined, function (oProperties) {
            if (controlType) {
    ...
    Renderer.prototype.addSubHeader = function (controlType, oControlProperties, bIsVisible, bCurrentState, aStates) {
        ...
        oControlInstance = this.createItem(oControlProperties, bCurrentState, function (oProperties) {
            if (controlType) {
                if (bResourceLoadedAsObject) {
                    return new ControlObject(oProperties);
                }
     ...
     * The icon is displayed in the right side of the Fiori Launchpad shell header or in an shell header overflow popup.</br>
     *
     * <b>Example:</b>
     * <pre>
     * var oRenderer = sap.ushell.Container.getRenderer("fiori2");
    ...
    Renderer.prototype.addEndUserFeedbackCustomUI = function (oCustomUIContent, bShowCustomUIContent) {
        if (oCustomUIContent || bShowCustomUIContent) {
            Log.info("Application calls sap.ushell.Rederer.addEndUserFeedbackCustomUI. This funciton is deprecated. The call has no effect.");
        }
    };
     ...
     * @private
     */
    Renderer.prototype.makeEndUserFeedbackAnonymousByDefault = jQuery.noop;
     ...
     * @private
     */
    Renderer.prototype.showEndUserFeedbackLegalAgreement = jQuery.noop;
    ...
    /**
     * Calls the provider with an object providing the tile informations
    ...
    Renderer.prototype.updateHeaderItem = function (sId, oControlProperties) {
        var oItem = sap.ui.getCore().byId(sId);
