...
sap.ui.define([
    ...
    function getInnerAppRoute (oTemplatePayload) {
        ...
        var sHashFragment = window.hasher.getHash();
    ...
    function createEnv () {
        return new Promise(function (fnResolve) {
            Promise.all([
                ...
                var sContentDensity = oUser.getContentDensity() || (jQuery("body").hasClass("sapUiSizeCompact") ? "compact" : "cozy");
            ...
            createEnv().then(function (oEnv) {
                ...
                if (oCapabilities.appFrameworkId === "UI5" && oRuntime.startupParameter) {
                    ...
                    if (oMatchingTarget.mappedDefaultedParamNames && oMatchingTarget.mappedDefaultedParamNames.length > 0) {
                        oRuntime.startupParameter["sap-ushell-defaultedParameterNames"] = [JSON.stringify(oMatchingTarget.mappedDefaultedParamNames)];
                    }
                }
