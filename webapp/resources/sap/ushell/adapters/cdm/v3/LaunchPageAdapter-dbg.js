    ...
    function LaunchPageAdapter (oUnused, sParameter, oAdapterConfiguration) {
        ...
        this.addCustomBookmark = function (oBookmarkConfig, oTargetGroup, sContentProviderId) {
            ...
            Promise.all([
                ...
                jQuery.when(oTargetGroup || this.getDefaultGroup(), oCdmSiteService.getSite())
                    .done(function (oGroup, oSite) {
                        var oTarget,
                            oIntent = oUrlParsing.parseShellHash(oBookmarkConfig.url),
                            bIsUrlBookmarkTile = (oIntent === undefined);

                        oTarget = bIsUrlBookmarkTile ? createNewTargetFromUrl(oBookmarkConfig.url) : createNewTargetFromIntent(oIntent);
        ...
        this.getTileActions = function (oTile) {
            ...
            if (this._isGroupTile(oTile) && !this._isFailedGroupTile(oTile)) {
                ...
                oTileSettingsAction = oUtils.getTileSettingsAction(oModel, this._onTileSettingsSave.bind(this, oTile), this.getTileType(oTile));
