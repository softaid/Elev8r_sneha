...
sap.ui.define([
    ...
    ShellHeader.prototype._adjustAppTitleTooltip = function () {
        var oAppTitle = sap.ui.getCore().byId("shellAppTitle");
        if (oAppTitle) {
            ...
            if (oSpanElement) {
                ...
                var oNavMenu = sap.ui.getCore().byId(oAppTitle.getNavigationMenu());
    ...
    ShellHeader.prototype._getLeanMode = function () {
        return (window.location.search || "").indexOf("appState=lean") >= 0;
    };
