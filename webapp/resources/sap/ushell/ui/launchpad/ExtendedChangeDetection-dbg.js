...
sap.ui.define([
    ...
    ExtendedChangeDetection.prototype._updateAggregation = function () {
        ...
        var bUpdateFromSibling = this._isUpdateFromSibiling();
        ...
        if (aDiff) {
            ...
            for (i = 0; i < aInsertedItems.length; i++) {
                oInsertedItem = aInsertedItems[i];
                oRemovedControl = oRemovedControls[oInsertedItem.item];

                // This second check is needed to force creation of visualizations
                // when their dispayFormat changed.
     ...
     * @private
     */
    ExtendedChangeDetection.prototype._isUpdateFromSibiling = function () {
