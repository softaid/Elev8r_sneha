...
sap.ui.define([], function() {
	 ...
	 * @param {boolean} oSettings.configOnly=false] if set to <code>true</code>, only the control configuration will be checked.
	...
	ODataControlSelector.prototype.checkComboBox = function(oSettings) {
		...
		if (typeof oSettings !== "undefined") {
			if (typeof oSettings === "boolean") {
				bConfigOnly = oSettings;
			} else {
				bConfigOnly = oSettings.configOnly;
		...
		return this._checkComboBox(bConfigOnly);
	};

	ODataControlSelector.prototype._checkComboBox = function(bConfigOnly) {
		var oResult = {};
