...
sap.ui.define([
	...
	'sap/m/table/Util'
], function(jQuery, library, EventProvider, ODataType, MetadataAnalyser, FormatUtil, DateTimeUtil, Log, Token, Filter, FilterOperator, TableUtil) { //
	"use strict";
	...
	BaseValueListProvider.prototype._resolveAnnotationData = function(oAnnotation) {
		var iLen = 0, i = 0, aCols, oField, aHighImportanceFields;
	...
	BaseValueListProvider.prototype._isFieldHiddenInFilterBar = function (oFilterBar, sFieldName) {
		...
		return !oFilterItem || !oFilterItem.getVisibleInAdvancedArea();
	};
