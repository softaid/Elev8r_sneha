...
sap.ui.define([
	...
	ContentDeliveryService.prototype.getSkipLowLODRendering = function() {
		return this._loader.getSkipLowLODRendering();
	};
	...
	ContentDeliveryService.prototype.initUrl = function(url, keepCachedData, correlationId) {
		...
		if (!this._loader.running() || this._loader.getUrl() !== url) {
			...
			this._loader.setCorrelationId(correlationId ? correlationId : THREE.Math.generateUUID().toLowerCase());
