...
sap.ui.define(["sap/ui/thirdparty/jquery", "./library", 'sap/ui/core/Core', "sap/ui/core/Item", 'sap/ui/core/Icon',
	'./CustomNavigationListItem', 'sap/ui/core/InvisibleText', 'sap/ui/core/Renderer', 'sap/ui/core/IconPool', "sap/ui/events/KeyCodes", "sap/ui/core/library",
	...
	function (jQuery, library, Core, Item, Icon,
		CustomNavigationListItem, InvisibleText, Renderer, IconPool, KeyCodes, coreLibrary, openWindow, defaultLinkTypes) {
		"use strict";
		 ...
		 */
		var CustomNavigationListItem = Item.extend("sap.tnt.NavigationListItem", /** @lends sap.tnt.CustomNavigationListItem.prototype */ {
			metadata: {
				library: "sap.tnt",
				properties: {
					/**
		...
		CustomNavigationListItem.expandIcon = 'sap-icon://navigation-right-arrow';
		CustomNavigationListItem.collapseIcon = 'sap-icon://navigation-down-arrow';


		CustomNavigationListItem._getInvisibleText = function () {
		 ...
		 * @override
		 */
		CustomNavigationListItem.prototype.init = function () {
		 ...
		 * @private
		 */
		CustomNavigationListItem.prototype._getUniqueKey = function () {
		 ...
		 * @private
		 */
		CustomNavigationListItem.prototype._getExpandIconControl = function () {
			...
			if (!expandIconControl) {
				...
				expandIconControl = new Icon({
					src: expanded ? CustomNavigationListItem.collapseIcon : CustomNavigationListItem.expandIcon,
		 ...
		 * @private
		 */
		CustomNavigationListItem.prototype._getExpandIconTooltip = function (expand) {
		 ...
		 * @private
		 */
		CustomNavigationListItem.prototype.getLevel = function () {
			var level = 0;
		 ...
		 * @private
		 */
		CustomNavigationListItem.prototype.getNavigationList = function () {
			var parent = this.getParent();
		 ...
		 * @private
		 */
		CustomNavigationListItem.prototype._isListExpanded = function () {
		 ...
		 * @private
		 */
		CustomNavigationListItem.prototype.createPopupList = function () {
		 ...
		 * @private
		 */
		CustomNavigationListItem.prototype.onPopupItemSelect = function (event) {
		 ...
		 * @private
		 */
		CustomNavigationListItem.prototype._selectItem = function (event) {
		 ...
		 * @private
		 */
		CustomNavigationListItem.prototype._openUrl = function () {
		 ...
		 * @private
		 */
		CustomNavigationListItem.prototype.onkeydown = function (event) {
		 ...
		 */
		CustomNavigationListItem.prototype.expand = function (duration) {
			...
			expandIconControl.setSrc(CustomNavigationListItem.collapseIcon);
		 ...
		 */
		CustomNavigationListItem.prototype.collapse = function (duration) {
			if (!this.getExpanded() || !this.getHasExpander() ||
				this.getItems().length == 0 || this.getLevel() > 0) {
				return;
			}
			...
			var expandIconControl = this._getExpandIconControl();
			expandIconControl.setSrc(CustomNavigationListItem.expandIcon);
		 ...
		 * @private
		 */
		CustomNavigationListItem.prototype.ontap = function (event) {
		...
		CustomNavigationListItem.prototype.onsapenter = CustomNavigationListItem.prototype.ontap;
		CustomNavigationListItem.prototype.onsapspace = CustomNavigationListItem.prototype.ontap;

		/**
		 * Renders the item.
		 * @private
		 */
		CustomNavigationListItem.prototype.render = function (rm, control) {
			if (!this.getVisible()) {
				return;
			}
		 ...
		 * @private
		 */
		CustomNavigationListItem.prototype.renderGroupItem = function (rm, control) {
			...
			if (control.getExpanded()) {
				...
				expandIconControl.setSrc(this.getExpanded() ? CustomNavigationListItem.collapseIcon : CustomNavigationListItem.expandIcon);
		 ...
		 * @private
		 */
		CustomNavigationListItem.prototype.renderFirstLevelNavItem = function (rm, control) {
			var item,
				items = this._getVisibleItems(this),
				childrenLength = items.length,
		 ...
		 * @private
		 */
		CustomNavigationListItem.prototype.renderSecondLevelNavItem = function (rm, control) {
		 ...
		 * @private
		 */
		CustomNavigationListItem.prototype._renderIcon = function (rm) {
		 ...
		 * @private
		 */
		CustomNavigationListItem.prototype._renderText = function (rm) {
			rm.openStart('span');
			rm.class("sapMText");
		 ...
		 * @private
		 */
		CustomNavigationListItem.prototype._unselect = function () {
			var $this = this.$(),
				navList = this.getNavigationList();
		 ...
		 * @private
		 */
		CustomNavigationListItem.prototype._select = function () {
		 ...
		 * @private
		 */
		CustomNavigationListItem.prototype._getDomRefs = function () {
			var domRefs = [];
		 ...
		 * @private
		 */
		CustomNavigationListItem.prototype._getVisibleItems = function (control) {
			var visibleItems = [];
		...
		CustomNavigationListItem.prototype.onclick = function (event) {
		...
		CustomNavigationListItem.prototype.onmousedown = function (event) {
		...
		CustomNavigationListItem.prototype.onfocusin = function (event) {
		...
		CustomNavigationListItem.prototype._updateAccessibilityText = function () {
			var navList = this.getNavigationList(),
				invisibleText = CustomNavigationListItem._getInvisibleText();
		 ...
		 * @private
		 */
		CustomNavigationListItem.prototype._getAccessibilityPosition = function () {
			var parent = this.getParent(),
		 ...
		 * @private
		 */
		CustomNavigationListItem.prototype._getAccessibilityItem = function () {
		 ...
		 * @private
		 */
		CustomNavigationListItem.prototype._hasSelectedChild = function (selectedItem) {
		...
		return CustomNavigationListItem;
