                    ...
                    if (oControl.getBinding(aValidateProperties[i])) {
                        ...
                        if (oControl.getBinding(aValidateProperties[i]).getType()) {
                            ...
                            // catch any validation errors
                                ...
                                var controlValue = oControl.mProperties.value;
                                var erroeMessage = oControl.mProperties.valueStateText ;
                                var message = controlValue == "" ? oControl.mProperties.valueStateText : oControl.getBinding(aValidateProperties[i]).oType.oConstraints.errorText;

                                this._isValid = false;
                                oControlBinding = oControl.getBinding(aValidateProperties[i]);
                                sap.ui.getCore().getMessageManager().addMessages(
                                    new Message({
                                        message  : erroeMessage, //ex.message,
