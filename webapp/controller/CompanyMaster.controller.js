sap.ui.define([
	...
	return BaseController.extend("sap.ui.poultryerp.componentcontainer.controller.CompanyMaster", {
		...
		onInit: function () {
			...
			currentContext.initSideNavigation();
		...
		routeMatched: function (oEvent) {
			...
			if (MYSAP.SessionManager.getSession("currentSession") != null && sRouteName == "login") {
				this.getRouter().getTargets().display("chome", {});
				this.getRouter().navTo("chome", true);
			}
		...
		initSideNavigation: function () {
			...
			var oModelSideNav = new JSONModel("model/CompanySetting.json");
