sap.ui.define([
    ...
    return BaseController.extend("sap.ui.elev8rerp.componentcontainer.controller.LeadManagement.AddOrder", {
        onInit: function () {
			...
			editDocumentCollectionModel.setData(emptyModel);
			this.getView().setModel(editDocumentCollectionModel, "editDocumentCollectionModel");
					...
					if (data[3][0].id != null) {
						...
						currentContext.resultArr.concat(currentContext.resultpdfArr).forEach((document) => {
							if (document.id == undefined) {
								orderService.saveDocumentCollectionDetails(
									{ ...objPush, ...document },
									function (obj) {
										if(obj){
        ...
        onPdfExport: function () {
            ...
            headertable1 += "{text: '" + pdfModel.oData.employeename + "', style: 'subheader'},";
            headertable1 += "{text: '" + pdfModel.oData.designation + "', style: 'subheader'},";
            headertable1 += "{text: '" + "Contact No. " + pdfModel.oData.mobileno + "', style: 'subheader'},";
            headertable1 += "{columns: [{text:'" + " " + "', style: 'subheader'},{text:'" + " " + "', style: 'subheaderone'}]},";
            headertable1 += "{columns: [{text:'" + " " + "', style: 'subheader'},{text:'" + " " + "', style: 'subheaderone'}]},";
            headertable1 += "{columns: [{text:'" + " " + "', style: 'subheader'},{text:'" + " " + "', style: 'subheaderone'}]},";
            headertable1 += "{columns: [{text:'" + " " + "', style: 'subheader'},{text:'" + " " + "', style: 'subheaderone'}]},";
