sap.ui.define([
    ...
    return BaseController.extend("sap.ui.elev8rerp.componentcontainer.controller.Sales.SalesInvoice", {
        ...
        onInit: function () {
            ...
            this.oFlexibleColumnLayout = this.byId("fclSalesInvoice");
        ...
        clearData: function () {
            ...
            this.oFlexibleColumnLayout = sap.ui.getCore().byId("componentcontainer---invoicegenerations--fclSalesInvoice");
        ...
        setDetailPage: function (channel, event, data) {
            this.detailView = sap.ui.view({
                viewName: "sap.ui.elev8rerp.componentcontainer.view.Sales." + data.viewName,
                type: "XML"
            });
