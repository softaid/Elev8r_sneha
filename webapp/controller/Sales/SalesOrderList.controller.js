sap.ui.define([
    ...
    return BaseController.extend("sap.ui.elev8rerp.componentcontainer.controller.Sales.SalesOrderList", {
        ...
        add: function() {
            ...
            setTimeout(function () {
                this.bus = sap.ui.getCore().getEventBus();
                this.bus.publish("salesorder", "handleSalesOrderList", { pagekey: "salesorder", viewModel:null });
            }, 1000);
            this.bus.publish("salesorder", "handleSalesOrderList", { pagekey: "salesorder", viewModel:null});
        ...
        edit: function (oEvent) { 
            ...
            setTimeout(function () {
                _this.bus = sap.ui.getCore().getEventBus();
                _this.bus.publish("salesorder", "handleSalesOrderList", { pagekey: "salesorder", viewModel:viewModel });
            }, 1000);
