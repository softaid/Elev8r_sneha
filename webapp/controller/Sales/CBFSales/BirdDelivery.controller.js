sap.ui.define([
	...
	return BaseController.extend("sap.ui.elev8rerp.componentcontainer.controller.Sales.CBFSales.BirdDelivery", {
		
		onInit: function () {
            this.bus = sap.ui.getCore().getEventBus();
            this.bus.subscribe("cbfbirddelivey", "setDetailPage", this.setDetailPage, this);     
            this.oFlexibleColumnLayout = this.byId("fclCBFBirdDelivery");

			// set model for list dialog
			var oModel = new JSONModel(jQuery.sap.getModulePath("sap.ui.elev8rerp.componentcontainer.model.Sales.CBFSales", "/birddelivery.json"));
		...
		{
			this.bus = sap.ui.getCore().getEventBus();
            this.bus.publish("cbfbirddelivey", "setDetailPage", {viewName:"BirdDeliveryContentDetail"});
		},
        ...
        onListIconPress: function(oEvent) {
		   if (!this._oDialog) {
			  this._oDialog = sap.ui.xmlfragment("sap.ui.elev8rerp.componentcontainer.fragmentview.Sales.CBFSales.BirdDeliveryDialog", this);
		   }
	    ...
	    bindDetailTable : function(oModel)
	   {
          ...
          var oTable = this.getView().byId("tblCBFBirdDeliveryContent");
	           ...
	           cells : [ new sap.m.Text({
                        ...
                        text : "{dataModel>whse}"
	                        ...
	                        press: function (e) {
		                        ...
		                        currentContext.bus.publish("cbfbirddelivey", "setDetailPage", {viewName:"BirdDeliveryContentDetail", viewModel : model});
	                        }
	                 })
	             ]
           });
