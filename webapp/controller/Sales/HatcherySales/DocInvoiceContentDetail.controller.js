sap.ui.define([
	...
	return BaseController.extend("sap.ui.elev8rerp.componentcontainer.controller.Sales.HatcherySales.DocInvoiceContentDetail", {
		onInit: function () {
		...
		onCancel : function()
		{
			this.oFlexibleColumnLayout = sap.ui.getCore().byId("componentcontainer---hatcherydocinvoice--fclHatcheryDocInvoice");
