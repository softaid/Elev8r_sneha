sap.ui.define([
	...
	return BaseController.extend("sap.ui.elev8rerp.componentcontainer.controller.Sales.HatcherySales.DocDelivery", {
		
		onInit: function () {
            this.bus = sap.ui.getCore().getEventBus();
            this.bus.subscribe("docdelivery", "setDetailPage", this.setDetailPage, this);     
            this.oFlexibleColumnLayout = this.byId("fclHatcheryDocDelivery");

			// set model for list dialog
			var oModel = new JSONModel(jQuery.sap.getModulePath("sap.ui.elev8rerp.componentcontainer.model.Sales.HatcherySales", "/docdelivery.json"));
		...
		{
			this.bus = sap.ui.getCore().getEventBus();
            this.bus.publish("docdelivery", "setDetailPage", {viewName:"DocDeliveryContentDetail"});
		},
        ...
        onListIconPress: function(oEvent) {
		   if (!this._oDialog) {
			  this._oDialog = sap.ui.xmlfragment("sap.ui.elev8rerp.componentcontainer.fragmentview.Sales.HatcherySales.DocDeliveryDialog", this);
		   }
	    ...
	    handleSearch: function(oEvent) {
		   ...
		   var columns = ['customer', 'name','postingDate','deliveryDate','docDate'];			
	    ...
	    bindDetailTable : function(oModel)
	   {
          ...
          var oTable = this.getView().byId("tblHatcheryDocDelivery");
		  oTable.setModel(oModel,"dataModel");
		  

		 // console.log("tbleModel : ",oTable.getModel("dataModel"));
          // Template
	           ...
	           cells : [ new sap.m.Text({
                        ...
                        text : "{dataModel>whse}"
	                        ...
	                        press: function (e) {
		                        ...
		                        currentContext.bus.publish("docdelivery", "setDetailPage", {viewName:"DocDeliveryContentDetail", viewModel : model});
	                        }
	                 })
	             ]
           });
