sap.ui.define([
	...
	return BaseController.extend("sap.ui.elev8rerp.componentcontainer.controller.Sales.BreederSales.InvoiceGenerationContentDetail", {
		onInit: function () {
		...
		onCancel : function()
		{
			this.oFlexibleColumnLayout = sap.ui.getCore().byId("componentcontainer---invoicegenerations--fclInvoiceGeneration");
