...
], function (JSONModel, BaseController, MessageBox, MessageToast, commonFunction, oSalesOrderService) {

    "use strict";

    return BaseController.extend("sap.ui.elev8rerp.componentcontainer.controller.Sales.BreederSales.SalesOrderList", {

        /**
         * Function to initialize sales order.
         */
        onInit: function () {
            ...
            oThis.bus.subscribe("salesorder", "handleSalesOrderList", oThis.handleSalesOrderList, oThis);

            let oSalesOrderList = new JSONModel();
            oSalesOrderList.setData([]);
            oThis.getView().setModel(oSalesOrderList, "oSalesOrderList");
        ...
        /**
         * Function to submit search parameters of sales order form.
         */
        handleSearchData: function() {
            ...
            if(_this.validateForm()) {
                ...
                oSalesOrderService.getSalesOrderList({
                    from_date: sFromDate,
                    to_date: sToDate,
                }, function (data) {
                    ...
                    if(data.length > 0) {
                        ...
                        _this.getView().setModel(oModel, "oSalesOrderList1");
        ...
        /**
         * Function to redirect to add screen of sales order form.
         */
        add: function() {
            ...
            setTimeout(function () {
                this.bus = sap.ui.getCore().getEventBus();
                this.bus.publish("salesorder", "handleSalesOrderList", { pagekey: "breedersalesorder", viewModel:null });
            }, 1000);
            this.bus.publish("salesorder", "handleSalesOrderList", { pagekey: "breedersalesorder", viewModel:null});
        ...
        /**
         * Function to validate the sales order form.
         * @returns 
         */
        ...
        /**
         * Function to filter search criteria of sales order.
         * @param {*} oEvent 
         */
        search: function (oEvent) {

            this._aTableFilters = []
			var oModel = this.getView().getModel("oSalesOrderList1").oData.modelData;
			...
			if (sQuery) {
                ...
                if (foundKey !== "") {
					...
					this.getView().setModel(oModel, "oSalesOrderList");
        ...
        /**
         * Function to sort the search results of sales order.
         * @param {*} oEvent 
         */
        sort: function (oEvent) {
            ...
            var oView = this.getView(),
                ...
                oSorter = new sap.ui.model.Sorter("salesorderno", this._bDescendingSort);
            oBinding.sort(oSorter);
        },

        /**
         * Function to redirect to edit screen of sales order.
         * @param {*} oEvent 
         */
        edit: function (oEvent) { 
            
            let _this = this;
            let viewModel = oEvent.getSource().getBindingContext("oSalesOrderList").getObject();
            ...
            setTimeout(function () {
                _this.bus = sap.ui.getCore().getEventBus();
                _this.bus.publish("salesorder", "handleSalesOrderList", { pagekey: "breedersalesorder", viewModel:viewModel });
            }, 1000);
        ...
        /**
         * Function to redirect to view screen of sales order.
         * @param {*} oEvent 
         */
        ...
        /**
         * Function to set pagination for search results of sales order.
         */
        setPagination: function () {
			
            if(typeof this.getView().getModel("oSalesOrderList1") !== "undefined") {

                let data = this.getView().getModel("oSalesOrderList1").oData.modelData;
                ...
                currentContext.getView().setModel(oModel, "oSalesOrderList");
        ...
        /**
         * Function to sort and filter search results of sales order.
         * @param {*} aData 
         * @returns 
         */
