...
], function (JSONModel, BaseController, MessageBox, MessageToast, commonFunction, oSalesInvoiceService) {

    "use strict";

    return BaseController.extend("sap.ui.elev8rerp.componentcontainer.controller.Sales.BreederSales.SalesInvoiceList", {

        /**
         * Function to initialize sales invoice.
         */
        onInit: function () {
            ...
            oThis.bus.subscribe("salesinvoice", "handleSalesInvoiceList", oThis.handleSalesInvoiceList, oThis);

            let oSalesInvoiceList = new JSONModel();
            oSalesInvoiceList.setData([]);
            oThis.getView().setModel(oSalesInvoiceList, "oSalesInvoiceList");
        ...
        /**
         * Function to submit search parameters of sales invoice form.
         */
        handleSearchData: function() {
            ...
            if(_this.validateForm()) {
                ...
                oSalesInvoiceService.getSalesInvoiceList({
                    from_date: sFromDate,
                    to_date: sToDate,
                }, function (data) {
                    ...
                    if(data.length > 0) {
                        ...
                        _this.getView().setModel(oModel, "oSalesInvoiceList1");
        ...
        /**
         * Function to redirect to add screen of sales invoice form.
         */
        add: function() {
            ...
            setTimeout(function () {
                this.bus = sap.ui.getCore().getEventBus();
                this.bus.publish("salesinvoice", "handleSalesInvoiceList", { pagekey: "invoicegenerations", viewModel:null });
            }, 1000);
            this.bus.publish("salesinvoice", "handleSalesInvoiceList", { pagekey: "invoicegenerations", viewModel:null});
        ...
        /**
         * Function to validate the sales invoice form.
         * @returns 
         */
        ...
        /**
         * Function to filter search criteria of sales invoice.
         * @param {*} oEvent 
         */
        search: function (oEvent) {

            this._aTableFilters = []
			var oModel = this.getView().getModel("oSalesInvoiceList1").oData.modelData;
			...
			if (sQuery) {
                ...
                if (foundKey !== "") {
					...
					this.getView().setModel(oModel, "oSalesInvoiceList");
        ...
        /**
         * Function to sort the search results of sales invoice.
         * @param {*} oEvent 
         */
        sort: function (oEvent) {
            ...
            var oView = this.getView(),
                ...
                oSorter = new sap.ui.model.Sorter("salesinvoiceno", this._bDescendingSort);
        ...
        edit: function (oEvent) { 
            ...
            let _this = this;
            let viewModel = oEvent.getSource().getBindingContext("oSalesInvoiceList").getObject();
        ...
        /**
         * Function to redirect to view screen of sales invoice.
         * @param {*} oEvent 
         */
        ...
        /**
         * Function to set pagination for search results of sales invoice.
         */
        setPagination: function () {
			
            if(typeof this.getView().getModel("oSalesInvoiceList1") !== "undefined") {

                let data = this.getView().getModel("oSalesInvoiceList1").oData.modelData;
                ...
                currentContext.getView().setModel(oModel, "oSalesInvoiceList");
        ...
        /**
         * Function to sort and filter search results of sales invoice.
         * @param {*} aData 
         * @returns 
         */
