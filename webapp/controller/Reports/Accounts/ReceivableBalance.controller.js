sap.ui.define([
    ...
    return BaseController.extend("sap.ui.elev8rerp.componentcontainer.controller.Reports.Accounts.ReceivableBalance", {
        onInit: function () {
        ...
        bindTbl: function () {
            ...
            accountsReportsService.getReceivableBalanceReport({partyid: partystr, fromdate: pModel["fromdate"], todate: pModel["todate"] }, function (data) {
