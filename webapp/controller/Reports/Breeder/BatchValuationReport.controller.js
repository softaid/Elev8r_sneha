sap.ui.define([
    ...
    return BaseController.extend("sap.ui.elev8rerp.componentcontainer.controller.Reports.Breeder.BatchValuationReport", {
        ...
        onInit: function () {
            ...
            this.getView().setModel(model, "batchvaluationModel");
        ...
        onBreederBatchDialogClose: function (oEvent) {
            ...
            if (aContexts != undefined) {
                ...
                var oModel = currentContext.getView().getModel("batchvaluationModel");
        ...
        resetModel: function () {
            var tbleModel = this.getView().getModel("batchvaluationtblModel");
        ...
        onSearchData: function () {
            if (this.validateForm()) {
                var currentContext = this;
                var oModel = this.getView().getModel("batchvaluationModel").oData

                var oModel = {
                    breederbatchid: oModel.breederbatchid,
                }

                breederReportsService.getBatchValuationReport(oModel, function (data) {

                    var eModel = new sap.ui.model.json.JSONModel();
                    eModel.setData({ modelData: data[0]});
                    currentContext.getView().setModel(eModel, "batchvaluationtblModel");
        ...
        onDataExport: sap.m.Table.prototype.exportData || function (oEvent) {
            ...
            var oExport = new Export({
                ...
                models: currentContext.getView().getModel("batchvaluationtblModel"),
