sap.ui.define([
    ...
    return BaseController.extend("sap.ui.elev8rerp.componentcontainer.controller.Reports.CBF.DensityRegisterReport", {
        ...
        onSearchDensityRegisterReport: function () {
            if (this.validateForm()) {
                ...
                var fromage = oModel.oData.fromage;
                var toage = oModel.oData.toage;

                cBFReportsService.getDensityReport({ fromdate: fromdate, todate: todate, fromage: fromage, toage: toage, branch_id: batchesStr, line_id: lineStr }, function async(data) {
        ...
        //         var fromage = that.getView().byId("fromage").getValue();
        //         var toage = that.getView().byId("toage").getValue();
        ...
        //                 text: this.getOwnerComponent().getModel("i18n").getResourceBundle().getText('Density Register Report'),
        ...
        onDataExport: sap.m.Table.prototype.exportData || function (oEvent) {
            ...
            var filename =fromdate+'_'+todate+'_'+fromage+'_'+toage+'_'+branchname+'_'+lineList;
