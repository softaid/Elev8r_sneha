sap.ui.define([
    ...
    return BaseController.extend("sap.ui.elev8rerp.componentcontainer.controller.Reports.CBF.BatchScheduleReport", {
        ...
        getbatchscheduleReport: function () {
            ...
            if (this.validateForm()) {
                ...
                cBFReportsService.getAllBatchsheduleReport({ branchid: branchStr, id: lineStr }, function async(data) {
		    ...
		    if(data[0].length > 0) {
                    ...
                    {
			  MessageBox.error("Batch not scheduled");
                    } 
        ...
        branchSelectionFinish: function (oEvt) {
            ...
            var brabchids = branch.join();
            cBFReportsService.getAllLine({ branchid: brabchids }, function (data) {
            ...
            var docDefinition = {
                ...
                content: [
...

                    {
                        ...
                        text: this.getOwnerComponent().getModel("i18n").getResourceBundle().getText('Batch Shedule Report'),
        ...
        onDataExport: sap.m.Table.prototype.exportData || function (oEvent) {
            ...
            var oExport = new Export({
                ...
                columns: [
                    ...
                    {
                        name: "	Batch Quantity",
                        template: { content: "{batch_qty}" }
                    },
                    {
                        name: "	Batch Place Quantity",
