sap.ui.define([
    ...
    return BaseController.extend("sap.ui.elev8rerp.componentcontainer.controller.Reports.CBF.ChickPlacementRegisterReport", {
        ...
        var filename =fromdate+'_'+todate+'_'+branchname+'_'+lineList;
            ...
            var oExport = new Export({
                ...
                columns: [
                    {
                        name: "Placement Date",
                        template: { content: "{finalplacedate}" }
                    },
                    {
                        name: "Batch Number",
		    ...
		    {
                        name: "Free Qty",
                        template: { content: "{free_qty}" }
                    },
		    {
                        name: "Shortage Chicks",
                        template: { content: "{shortage}" }
                    },
