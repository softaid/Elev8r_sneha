sap.ui.define([
    ...
    return BaseController.extend("sap.ui.elev8rerp.componentcontainer.controller.Reports.CBF.StockOfLiveBirdsReport", {
        ...
        replaceTemplateData: function (template) {
            ...
            for (var indx in tblModel) {
                ...
                htmTable += "<tr>";
                htmTable += "<td align='center'>" + model["farmid"] + "</td>"
                htmTable += "<td align='center'>" + model["batch_number"] + "</td>"
            ...
            template = this.replaceStr(template, "##ReportFromDate##", curdate);
        ...
        createPDF: function () {
            ...
            commonFunction.getHtmlTemplate("CBF", "StockOfLiveBirdReport.template.html", function (dataHtml) {
                var template = dataHtml.toString();
                template = currentContext.replaceTemplateData(template);
                commonFunction.generatePDF(template, "Stock Of Live Bird Report");
            });
        },

        // Function for pdf finish

        onSearchStockOfLiveBirdeport: function () {
            if (this.validateForm()) {
                ...
                cBFReportsService.getAllBatchOfLivestock({ curdate: curdate, branch_id: batchesStr, line_id: lineStr }, function async(data) {
        ...
        validateForm: function () {
            ...
            if (!commonFunction.isRequired(this, "curdate", "Current Date is required"))
                isValid = false;
        ...
        onPdfExport: function (oEvent) {
            ...
            var createListData = function () {
                ...
                var fromdate = that.getView().byId("curdate").getValue();
            ...
            var docDefinition = {
                ...
                content: [
...

                    {
                        ...
                        text: this.getOwnerComponent().getModel("i18n").getResourceBundle().getText(' Stock Of Live Bird Report'),

                        style: 'title',
                        margin: [0, 100, 150, 10]
                    },
                    {
                        text: "Report Genaration date:",
                        style: 'filter',
                        bold: true
                    },
        ...
        onDataExport: sap.m.Table.prototype.exportData || function (oEvent) {
            ...
            var filename =fromdate+'_'+branchname+'_'+lineList;
