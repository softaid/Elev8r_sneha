sap.ui.define([
    ...
    return BaseController.extend("sap.ui.elev8rerp.componentcontainer.controller.Reports.CommercialLayer.LayerBatchwiseProfitAndLossReport", {
        ...
        onInit: function () {
            ...
            this.getView().setModel(model, "layerbatchpandlModel");
        ...
        onLayerBatchDialogClose: function (oEvent) {
            ...
            if (aContexts != undefined) {
                ...
                var oModel = currentContext.getView().getModel("layerbatchpandlModel");
        ...
        resetModel: function () {
            var tbleModel = this.getView().getModel("layerbatchwiseIncomeModel");
            tbleModel.setData({ modelData: [] });

            var tbleModel1 = this.getView().getModel("layerbatchwiseExpensesModel");
        ...
        onSearchData: function () {
            if (this.validateForm()) {
                var currentContext = this;
                var oModel = this.getView().getModel("layerbatchpandlModel").oData
                ...
                layerReportsService.getlayerbatchwiseprofitandlossReport(oModel, function (data) {
                    console.log(data);
                    ...
                    currentContext.getView().setModel(eModel, "layerbatchwiseExpensesModel");
                    ...
                    currentContext.getView().setModel(iModel, "layerbatchwiseIncomeModel");
