...
], function (JSONModel, BaseController, MessageToast, MessageBox, Export, ExportTypeCSV, commonFunction, layerReportsService, layerBatchService, commonService) {
    "use strict";

    return BaseController.extend("sap.ui.elev8rerp.componentcontainer.controller.Reports.CommercialLayer.LayerBatchDetailReport", {
        ...
        onSearchData: function () {
            if (this.validateForm()) {
                ...
                layerReportsService.getBatchDetailData(oModel, function async(data) {
        ...
        onDataExport: sap.m.Table.prototype.exportData || function (oEvent) {
            ...
            var oExport = new Export({
                ...
                columns: [
                    ...
                    {
                        name: "Egg %",
                        template: { content: "{eggper}" }
                    },

                    {
                        name: "Feed/Bird",
                        template: { content: "{feedperbird}" }
                    },
                    {
                        name: "Cummu Egg",
                        template: { content: "{cummuegg}" }
                    },

                    {
                        name: "Cummu Feed",
                        template: { content: "{cummufeedcon}" }
                    },

                    {
                        name: "Cummu Mortality",
                        template: { content: "{cummmortality}" }
                    },

                    {
                        name: "Cummu Egg/Bird",
                        template: { content: "{cummeggperbird}" }
                    },
                    {
                        name: "Cummu Feed/Egg",
                        template: { content: "{cummfeedperegg}" }
                    },

                    {
                        name: "Cummu Mortality Per",
                        template: { content: "{cummumorper}" }
                    },
