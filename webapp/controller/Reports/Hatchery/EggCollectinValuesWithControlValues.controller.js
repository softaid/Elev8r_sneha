sap.ui.define([
    ...
    return BaseController.extend("sap.ui.elev8rerp.componentcontainer.controller.Reports.Hatchery.EggCollectinValuesWithControlValues", {
        ...
        onSearchData: function () {
            if (this.validateForm()) {
                ...
                hatcheryReportsService.getEggcollectionValueWthControlValue(oModel, function (data) {
        ...
        replaceTemplateData: function (template) {           
            ...
            for (var indx in tbleModel) {
                ...
                htmTable += "<td>" + model["sheduleid"] + "</td>"
                htmTable += "<td align='right'>" + model["batchname"] + "</td>"
        ...
        createPDF: function () {
            var currentContext = this;
            commonFunction.getHtmlTemplate("Hatchery", "Eggcollectionwthcontrolvalues.template.html", function (dataHtml) {
                var template = dataHtml.toString();
                template = currentContext.replaceTemplateData(template);
                commonFunction.generatePDF(template, "Egg Collection Value With Control Values Report");
            });
        },
