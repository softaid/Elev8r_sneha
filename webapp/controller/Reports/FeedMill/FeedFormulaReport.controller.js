...
], function (JSONModel, BaseController, MessageBox, Export, ExportTypeCSV, commonFunction, feedMillReportsService, commonService) {
    "use strict";

    return BaseController.extend("sap.ui.elev8rerp.componentcontainer.controller.Reports.FeedMill.FeedFormulaReport", {
        ...
        onInit: function () {
            ...
            // This funcion get all itemgroups which are available
            ...
            // set tblModel which contains data in array format
        ...
        // clear data which is present on report
        resetModel: function () {
        ...
        /**
         * function used for get data for Feed Formula Report
         */
        onSearchFeedFormulaReport: function () {
            if (this.validateForm()) {
                ...
                feedMillReportsService.getFeedFormulaReport({ fromdate: fromdate, todate: todate, itemgroupid: itemgroupStr, itemid: itemStr }, function async(data) {
