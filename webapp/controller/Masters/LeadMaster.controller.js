...
sap.ui.define([
    ...
    return BaseController.extend("sap.ui.elev8rerp.componentcontainer.controller.Masters.LeadMaster", {
        ...
        onInit: function () {
            ...
            var leadMasterModel = new JSONModel();
            leadMasterModel.setData(emptyModel);
            this.getView().setModel(leadMasterModel, "leadMasterModel");
        ...
        getReferenceTypeByMaster: function () {
            var currentContext = this;
            masterService.getReferenceTypeByMaster({master : 'LeadMaster'},function (data) {
                console.log(data);
                ...
                var pModel = currentContext.getView().getModel("leadMasterModel");
        ...
        setDetailPage: function (channel, event, data) {
            this.detailView = sap.ui.view({
                viewName: "sap.ui.elev8rerp.componentcontainer.view.Masters.LeadMasterDetail",
                type: "XML"
            });
        ...
        onTabSelect: function (oControlEvent) {
            ...
            var pModel = this.getView().getModel("leadMasterModel");
        ...
        onAddIconPress: function (oEvent) {
            ...
            var oModel = this.getView().getModel("leadMasterModel");

            console.log("leadMasterModel : ",oModel);
            var model = {
                id: null,
