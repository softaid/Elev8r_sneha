...
sap.ui.define([
    ...
    return BaseController.extend("sap.ui.elev8rerp.componentcontainer.controller.Masters.NiMaster", {
        ...
        onInit: function () {
            ...
            var niMasterModel = new JSONModel();
            niMasterModel.setData(emptyModel);
            this.getView().setModel(niMasterModel, "niMasterModel");
        ...
        getReferenceTypeByMaster: function () {
            var currentContext = this;
            masterService.getReferenceTypeByMaster({ master: 'NiMaster' }, function (data) {
                console.log(data);
                ...
                var pModel = currentContext.getView().getModel("niMasterModel");
        ...
        setDetailPage: function (channel, event, data) {
            this.detailView = sap.ui.view({
                viewName: "sap.ui.elev8rerp.componentcontainer.view.Masters.NiMasterDetail",
                type: "XML"
            });
        ...
        onTabSelect: function (oControlEvent) {
            ...
            var pModel = this.getView().getModel("niMasterModel");
        ...
        onAddIconPress: function (oEvent) {
            ...
            var oModel = this.getView().getModel("niMasterModel");

            console.log("niMasterModel : ", oModel);
            var model = {
                id: null,
