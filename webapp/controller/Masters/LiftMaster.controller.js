...
sap.ui.define([
    ...
    return BaseController.extend("sap.ui.elev8rerp.componentcontainer.controller.Masters.LiftMaster", {

        onInit: function () {
            this.bus = sap.ui.getCore().getEventBus();
            this.bus.subscribe("master", "setDetailPage", this.setDetailPage, this);
            this.oFlexibleColumnLayout = this.byId("fclLiftMaster");
            ...
            var liftMasterModel = new JSONModel();
            liftMasterModel.setData(emptyModel);
            this.getView().setModel(liftMasterModel, "liftMasterModel");
        ...
        getReferenceTypeByMaster: function () {
            var currentContext = this;
            masterService.getReferenceTypeByMaster({master : 'LiftMaster'},function (data) {
                console.log(data);
                ...
                var pModel = currentContext.getView().getModel("liftMasterModel");
        ...
        setDetailPage: function (channel, event, data) {
            this.detailView = sap.ui.view({
                viewName: "sap.ui.elev8rerp.componentcontainer.view.Masters.LiftMasterDetail",
                type: "XML"
            });
        ...
        onTabSelect: function (oControlEvent) {
            ...
            var pModel = this.getView().getModel("liftMasterModel");
        ...
        onAddIconPress: function (oEvent) {
            ...
            var oModel = this.getView().getModel("liftMasterModel");

            console.log("liftMasterModel : ",oModel);
            var model = {
                id: null,
