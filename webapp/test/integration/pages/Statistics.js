			...
			assertions: {
				...
				iShouldSeeTheCharts: function () {
					if (sChartViewName.search("D3") >= 0) {
						this.waitFor({
							controlType: "sap.ui.elev8rerp.componentcontainer.control.D3PieChart",
							viewName: sChartViewName,
						...
						this.waitFor({
							controlType: "sap.ui.elev8rerp.componentcontainer.control.D3ColumnChart",
							viewName: sChartViewName,
							success: function (aCharts) {
						...
						this.waitFor({
							controlType: "sap.ui.elev8rerp.componentcontainer.control.D3ComparisonChart",
							viewName: sChartViewName,
							success: function (aCharts) {
						...
						this.waitFor({
							controlType: "sap.ui.elev8rerp.componentcontainer.control.D3Chart",
							viewName: sChartViewName,
							success: function (aCharts) {
